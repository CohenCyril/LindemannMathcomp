...
Record class_of R :=
  Class { base : NumClosedField.class_of R; mixin : archimedean_axiom (num_for R base) }.
...
Definition join_numArchiFieldType := @NumArchiField.Pack numClosedFieldType xclass xT.
